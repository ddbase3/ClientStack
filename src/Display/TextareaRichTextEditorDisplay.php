...
final class TextareaRichTextEditorDisplay implements IRichTextEditorDisplay {
	...
	public static function getName(): string {
		return 'textarearichtexteditordisplay';
	}
	...
	public function getHelp(): string {
		return 'Renders a native textarea as the fallback rich text editor control.';
	}
