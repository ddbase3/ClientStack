...
final class VectorDbProviderAdminDisplay implements IDisplay {

	private const SETTINGS_GROUP = 'vector-db-provider';
	...
	public static function getName(): string {
		return 'vectordbprovideradmindisplay';
	}

	public function getHelp(): string {
		return 'Configure vector database providers stored in settings group "vector-db-provider".';
	}
	...
	private function handleHtml(): string {
		...
		$this->view->setTemplate('Display/VectorDbProviderAdminDisplay.php');

		$instanceId = 'vectordbadm-' . uniqid();
